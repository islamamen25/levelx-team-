    ...
    <footer className="mt-auto border-t border-[var(--color-iron)] bg-[#F5F5F7]">
      <div className="container-px mx-auto py-14 md:py-16">
        ...
        <div className="mt-12 border-t border-[var(--color-iron)] pt-8">
          ...
          {/* A "دخول الإدارة" link sat here briefly. It was the first fix for the
              dashboard having no entry point, but the navbar sign-in icon replaced
              it — two links to the same page in one layout reads as an oversight,
              and the header one is both more discoverable and less odd on a
              customer-facing footer. Do not add it back; use the navbar icon. */}
          </div>
