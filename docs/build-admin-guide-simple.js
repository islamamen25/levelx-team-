...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      Gap(200),
      Warn("الجدول ده لصور المنتجات بس", [
        [R("الصور الكبيرة اللي فوق في الصفحة الرئيسية (السلايدر) ", { size: 22, color: INK }), R("مش بتترفع من اللوحة", { size: 22, bold: true, color: AMBER }), R(" — دي صور جاهزة مكتوبة جوّه الكود. لو عايز تغيّرها، دي شغلانة للمسؤول التقني.", { size: 22, color: INK })],
        [R("يعني الصور الوحيدة اللي بتجهّزها إنت هي ", { size: 22, color: INK }), R("صور المنتجات", { size: 22, bold: true, color: INK }), R(".", { size: 22, color: INK })],
      ]),
