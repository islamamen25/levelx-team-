...
> # ⛔ متقاعد — أُرشِف 2026-08-03
>
> **الحالة:** 🔴 **متوقّف.** الـ workflowان الاثنان `active: false` منذ 2026-08-03،
> ومؤكَّد عبر n8n API (آخر تنفيذ `277022`، ثم صمت تام).
>
> **البديل:** بيانات المنتجات تُولَّد عبر **cowork** وتُكتب في Supabase مباشرةً.
> عقد الكتابة في [`COWORK.md`](../../../COWORK.md) — اقرأه، لا هذا الملف.
>
> **لماذا بقي هذا الملف؟** لأنه السجل الوحيد لما كان يعمل فعلاً. إن أُعيد تشغيل
> الخط يوماً، ابدأ من هنا. المحتوى أدناه صحيح كوصف تاريخي (آخر تحقّق حيّ
> 2026-07-22)، لكن **حالة "🟢 يعمل" فيه لم تعد صحيحة**.
>
> **درس يستحق البقاء:** الخط أُعلن تقاعده 2026-07-25 كقرار استخدام، لكن الـ trigger
> ظل مُفعّلاً 9 أيام إضافية وأطلق ~13,000 تنفيذ على مجلد فارغ. *"بطّلنا نستخدمه"
> ليس دليلاً على أنه توقّف — افحص الـ trigger لا النية.*
