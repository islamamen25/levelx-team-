    ...
    children: [
      ...
      Tbl(
        ...
        [
          ...
          ["تاريخ التحديث", [R("٣ أغسطس ٢٠٢٦", { size: 19, color: GREY })]],
      ...
      Gap(160),
      Danger("٢) رفع الصور من اللوحة مش شغّال", [
        [R("مربع رفع الصور موجود في صفحة المنتج، لكنه ", {size:20,color:INK}), R("مرفوض من صلاحيات التخزين", {size:20,bold:true,color:RED}), R(" وهيرجّعلك رسالة خطأ. الصور بتترفع عن طريق سكربت خارجي بيشغّله المسؤول التقني. راجع الفصل ٦.", {size:20,color:INK})],
      ]),
      Gap(160),
      ...
      Step([R("احفظ، وبعدين افتح الصور من السكربت الخارجي (فصل ٦)", { size: 21, color: INK })]),
      ...
      // ══ 6 ══
      H1("٦. الصور"),
      Danger("رفع الصور من اللوحة مرفوض حالياً", [
        [R("لو سحبت صورة على مربع الرفع هتلاقي رسالة إنجليزية معناها: «رفع الصور محجوب بسبب صلاحيات التخزين — استخدم سكربت الصور بدلاً منه، وبعدين حدّث الصفحة».", { size: 20, color: INK })],
        [R("ده مش عطل مؤقت — الصور بتترفع بسكربت خارجي بيشغّله المسؤول التقني. جهّز الصور بالمواصفات تحت وابعتها له.", { size: 20, bold: true, color: RED })],
      ]),
      Gap(240),
      H2("٦.١ مواصفات الصورة"),
      Tbl(
        ["البند", "المطلوب", "ملاحظة"],
        [
          ["الشكل", "مربّعة ١:١", "كل صناديق العرض مربّعة"],
          ["المقاس المثالي", "١٥٠٠ × ١٥٠٠ بكسل", "واضحة على كل الشاشات"],
          ["أصغر مقاس", "١٠٠٠ × ١٠٠٠ بكسل", "أقل من كده بتبان ضبابية"],
          ["الحجم", "أقل من ٥٠٠ كيلوبايت", "عشان الصفحة تفتح بسرعة"],
          ["الصيغة", "JPG أو WebP", "WebP أفضل — حجم أقل"],
          ["الخلفية", "بيضاء أو شفافة", "مش صور دعائية"],
          ["العدد", "من ١ إلى ٦ للمنتج", "الأولى هي الرئيسية"],
        ],
        [2200, 3226, 3600]
      ),
      Gap(200),
      Body("الصور المستطيلة مش بتتقص ولا بتتشوّه — بيتحط حواليها إطار. لكن المربّعة بتبان أحسن."),
      ...
      Tbl(
        ...
        [
          ...
          ["رفع الصورة بيدّي خطأ", "صلاحيات التخزين — متوقّع", "ابعت الصور للمسؤول التقني"],
          ["عدّلت وما اتغيرش في الموقع", "الموقع بيخزّن مؤقتاً لمدة ساعة", "استنى شوية أو كلّم المسؤول التقني"],
          ["أرقام المبيعات غريبة", "دي بيانات تجريبية", "بُص في صفحة الطلبات"],
          ["مش عارف أدخل اللوحة", "الحساب مش مشرف", "كلّم المسؤول التقني"],
      ...
      P([R("انتهى الدليل — الإصدار ٢.٠", { size: 20, bold: true, color: GREY })], { alignment: AlignmentType.CENTER }),
      P([R("لو لقيت حاجة في الدليل ده مش مطابقة للشاشة، الشاشة هي الصح — بلّغ المسؤول التقني.", { size: 19, color: GREY })], { alignment: AlignmentType.CENTER }),
    ],
  }],
});
