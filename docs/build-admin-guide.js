...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      Gap(160),
      Danger("٢) خانة السعر الفاضية بتتحسب صفر — من غير أي تحذير", [
        [R("لو سبت ", {size:20,color:INK}), RL("Regular Price", {size:19,bold:true,color:INK}), R(" فاضية، الحفظ ", {size:20,color:INK}), R("بينجح", {size:20,bold:true,color:RED}), R(" والسعر بيتسجّل صفر — والمنتج بيتعرض للبيع بصفر جنيه. مفيش رسالة خطأ بتظهر لك، فده أخطر من الخانات اللي بترفض الحفظ.", {size:20,color:INK})],
        [R("بالمقابل ", {size:20,color:INK}), RL("SKU Code", {size:19,bold:true,color:INK}), R(" الفاضية ", {size:20,color:INK}), R("بترفض الحفظ", {size:20,bold:true,color:INK}), R(" برسالة بتسمّي الخانة ورقم الصف: ", {size:20,color:INK}), RL("Variant 1 — SKU is required", {size:18,bold:true,color:RED})],
      ]),
      Gap(160),
      ...
      Tbl(
        ...
        [
          ...
          [[R("الحفظ بيقول ", { size: 20, color: GREY }), RL("Validation failed", { size: 19, color: GREY })], "خانة إجبارية فاضية — غالباً SKU", "اقرا باقي الرسالة، بتسمّي الخانة والصف"],
          ["المنتج اتباع بصفر جنيه", "خانة السعر كانت فاضية فاتحسبت صفر", "افتح المنتج واكتب السعر الحقيقي"],
